...
public class ImageJ extends Frame implements ActionListener, MouseListener, KeyListener, WindowListener, ItemListener, Runnable {
	...
	public static final String BUILD = "14"; //*Changed for Bio7!*/
	...
	/* Changed for Bio7! */
	public static java.awt.Color getSystemColour() {
		Color col = null;
	...
	public void setFullScreen() {
		...
		if (currentPanel != null) {
			tabsBefore = CanvasView.tabFolder.getItemCount();
	...
	// Is there another instance of ImageJ? If so, send it the arguments and
	// quit.
