 ...
 */
public class ThresholdAdjuster extends PlugInDialog implements PlugIn, Measurements, Runnable, ActionListener,
		AdjustmentListener, ItemListener, FocusListener, KeyListener, MouseWheelListener, ImageListener {
...
//		maxSlider.addKeyListener(ij);
	...
	/**
	 * User has clicked 'Dark background'. Switch only if the current thresholds are
	 * consistent with the previous 'Dark background' state.
	 */
