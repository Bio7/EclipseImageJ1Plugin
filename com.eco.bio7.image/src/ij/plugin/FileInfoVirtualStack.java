...
public class FileInfoVirtualStack extends VirtualStack implements PlugIn {
	...
	/*
	 * Constructs a FileInfoVirtualStack from a FileInfo object and displays it if
	 * 'show' is true.
	 */
	...
	/**
	 * Returns an ImageProcessor for the specified image, where
	 * {@literal 1<=n<=nImages}. Returns null if the stack is empty.
	 */
