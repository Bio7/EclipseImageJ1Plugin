...
public class OpenDialog {
	...
	/**
	 * Returns the current working directory as a string ending in the separator
	...
	/**
	 * Returns the path to the directory that contains the last file opened or
	 * saved, or null if a file has not been opened or saved.
	 */
