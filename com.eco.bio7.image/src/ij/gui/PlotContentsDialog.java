 ...
 * Table", "Add Fit" and "More>Contents Style" dialogs
 */
public class PlotContentsDialog implements DialogListener {
	 ...
	 * ResultsTable. Use showDialog thereafter.
	 */
	 ...
	 * arrays as data. Each 'data' array in the ArrayList must have a corresponding
	 * element in the 'headings' array. 'defaultHeadings' may contain the headings
	 * of the items selected initially for x, y, x error and y error, respectively.
	 ...
	 * plot. Each 'data' array in the ArrayList must have a corresponding element in
	 * the 'headings' array. 'defaultHeadings' may contain the headings of the items
	 * selected initially for x, y, x error and y error, respectively.
	 * 'defaultHeadings' and each of its entries may be null, and the array may have
	 * any length.
	 */
	...
	public void showDialog(Frame parent) {
		...
		if (Recorder.record && !Recorder.scriptMode()) {
			if (dialogType == ADD_FROM_PLOT) {
				...
				String xSource = columnChoice[0].getSelectedIndex() == 0 ? "" : "Table.getColumn(\"" + columnChoice[0].getSelectedItem() + "\", \"" + tableChoice.getSelectedItem() + "\"), ";
				...
				if (columnChoice[2].getSelectedIndex() > 0)
					Recorder.recordString("Plot.add(\"xerror\", Table.getColumn(\"" + columnChoice[2].getSelectedItem() + "\", \"" + tableChoice.getSelectedItem() + "\"));\n");
				if (columnChoice[3].getSelectedIndex() > 0)
					Recorder.recordString("Plot.add(\"error\", Table.getColumn(\"" + columnChoice[3].getSelectedItem() + "\", \"" + tableChoice.getSelectedItem() + "\"));\n");
			}
	 ...
	 * having the index given. Does nothing with index < 0
	 */
	 ...
	 * settings and sets the Style fields for it.
	 */
	 ...
	 * dialog. Also sets 'defaultTableIndex'
	 */
	 ...
	 * the current Choice settings and sets the Style fields for it.
	 */
