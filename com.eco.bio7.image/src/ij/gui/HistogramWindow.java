...
public class HistogramWindow extends ImageWindow
	...
	private void setup(ImagePlus imp) {
		...
		value = new Label(" ");
		count = new Label(" ");
		value.setBackground(swtBackgroundToAWT);
		value.setForeground(swtForegroundToAWT);
		count.setBackground(swtBackgroundToAWT);
		count.setForeground(swtForegroundToAWT);
