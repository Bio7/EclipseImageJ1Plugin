...
public class ImageStack {
	...
	/**
	 * Creates a new, empty image stack with a capacity of 'size'. All 'size' slices
	 * and labels of this image stack are initially null.
	 */
	...
	/**
	 * Updates this stack so its attributes, such as min, max, calibration table and
	 * color model, are the same as 'ip'.
	 */
	 ...
	 * returned array may be greater than the number of slices currently in the
	 * stack. Returns null if the stack is empty or the label of the first slice is
	 * null.
	 */
	...
	/**
	 * Returns the label of the specified slice, were 1<=n<=nslices. Returns null if
	 * the slice does not have a label. For DICOM and FITS stacks, labels may
	 ...
	 * and suffix removed) of the label of the specified slice. Returns null if the
	...
	/**
	 * Assigns the pixel array of an ImageProcessor to the specified slice, were
	 * 1<=n<=nslices.
	 */
	...
	/**
	 * Returns, as a double, the value of the specified voxel. Throws an
	 * IndexOutOfBoundsException if x, y or z are beyond the stack limits. Use the
